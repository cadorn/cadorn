...
Similar to how *kubernetes binds service*s and *terraform binds infrastructure* I am working on mechanisms to **bind JavaScript/TypeScript components into systems and applications**.
